...
function InstrumentRegistration({ onBackClick }) {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:5000/api/instrumentos', instrumentData)
            .then(response => {
                Swal.fire({
                    icon: 'success',
                    title: 'Instrumento cadastrado com sucesso!',
            ...
            .catch(error => {
                ...
                let errorMessage = 'Erro ao cadastrar o instrumento. Tente novamente mais tarde.';
    ...
    return (
        <div className={styles.instrumentRegistrationContainer}>
            <h2 className={styles.header}>Cadastro de Instrumento</h2>
            <form onSubmit={handleSubmit} className={styles.instrumentForm}>
                ...
                <div className={styles.formActions}>
                    <button type="submit" className={styles.submitButton}>Cadastrar Instrumento</button>
